...
def generate_lesson(
  ...
  Here are some examples of how you should generate the output.   
    ...
    "lesson_introduction_message":"Today we're going to learn about verbs in Swahili. We'll see how verbs are structured and how to say '<span class='foreign-word' title='to do'>ku</span>' something as well as how to conjugate verbs to say '<span class='foreign-word' title='I am doing'>nina</span>' something. Let's dive in and explore some examples!",
  "interactions": [
    {{
      "explanation": "In Swahili, the infinitive form of verbs, equivalent to '<span class='foreign-word' title='to do'>ku</span>' in English, starts with '<span class='foreign-word' title='to'>ku</span>'. For example, '<span class='foreign-word' title='to sleep'>kulala</span>' and '<span class='foreign-word' title='to eat'>kula</span>'.",
      "question": "How do you say '<span class='foreign-word' title='to sleep'>kulala</span>' in Swahili?",
      "expected": "<span class='foreign-word' title='to sleep'>kulala</span>"
    }},
    {{
      "explanation": "To conjugate a verb in the present tense for '<span class='foreign-word' title='I'>ni</span>', we remove the '<span class='foreign-word' title='to'>ku</span>' and add '<span class='foreign-word' title='I am'>nina</span>' to the beginning. '<span class='foreign-word' title='I am'>Nina</span>' combines '<span class='foreign-word' title='I'>ni</span>' meaning '<span class='foreign-word' title='I'>I</span>' and '<span class='foreign-word' title='am'>na</span>' indicating present tense.",
      "question": "If '<span class='foreign-word' title='sleep'>lala</span>' is the verb meaning '<span class='foreign-word' title='sleep'>sleep</span>', how would you say '<span class='foreign-word' title='I sleep'>ninalala</span>' or '<span class='foreign-word' title='I am sleeping'>ninalala</span>'?",
      "expected": "<span class='foreign-word' title='I sleep'>ninalala</span>"
    }},
    {{
      "explanation": "Let's look at a couple more examples. '<span class='foreign-word' title='to read'>Kusoma</span>' in Swahili is '<span class='foreign-word' title='to read'>kusoma</span>' and '<span class='foreign-word' title='to write'>kuandika</span>'. Remember, to conjugate these in first person present tense, we drop the '<span class='foreign-word' title='to'>ku</span>' and add '<span class='foreign-word' title='I am'>nina</span>'.",
      "question": "How would you say '<span class='foreign-word' title='I am reading'>ninasoma</span>' in Swahili?",
      "expected": "<span class='foreign-word' title='I am reading'>ninasoma</span>"
    }},
    {{
      "explanation": "Great! Now let's practice with '<span class='foreign-word' title='to write'>kuandika</span>', which means '<span class='foreign-word' title='to write'>kuandika</span>'.",
      "question": "Using '<span class='foreign-word' title='to write'>kuandika</span>', how would you translate '<span class='foreign-word' title='I am writing'>ninaandika</span>' into Swahili?",
      "expected": "<span class='foreign-word' title='I am writing'>ninaandika</span>"
    }},
    {{
      "explanation": "Great! Now let's practice with '<span class='foreign-word' title='to write'>kuandika</span>', which means '<span class='foreign-word' title='to write'>kuandika</span>'.",
      "question": "Using '<span class='foreign-word' title='to write'>kuandika</span>', how would you translate '<span class='foreign-word' title='I am writing'>ninaandika</span>' into Swahili?",
  ...
  "lesson_closing_message": "Excellent work today! You've gotten the hang of forming infinitive verbs with '<span class='foreign-word' title='to'>ku</span>' and conjugating them in first person present tense using '<span class='foreign-word' title='I am'>nina</span>'. Keep practicing with even more verbs to expand your Swahili vocabulary and expression. I look forward to seeing you in the next lesson!",
...
def get_follow_on(
    ...
    When assessing if an answer is correct, you can be lenient on missing out punctuation and usage of synonyms. 
